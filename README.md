...
| input | output |
| --- | --- |
| <img src="https://netwrckstatic.netwrck.com/static/uploads/test/appnz-probe-fox.webp" width="320"> | `data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAABAAAAAQACAYAAAB/HSuDAAEAAElEQVR4nOz917NkyZHui33uoZZItV` |
<!-- /examples:hero -->
